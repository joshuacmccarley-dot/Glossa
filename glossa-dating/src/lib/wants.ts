...
export const WANTS: Want[] = [
  ...
  { id: "event_outdoors", label: "Outdoors crew", emoji: "", mode: "events", description: "Hiking, camping, climbing, adventures" },
  { id: "event_food", label: "Foodie meetups", emoji: "", mode: "events", description: "Restaurants, food tours, cooking events" },
  ...
  { id: "comm_neighbour", label: "Meet neighbours", emoji: "", mode: "community", description: "Build community close to home" },
